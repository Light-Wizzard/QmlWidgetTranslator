...
{
    QString theAppName = "QmlWidgetTranslator";
    QString theAppDisplayName = "Qml Widget Translator";
    ...
    Q_INIT_RESOURCE(QmlWidgetTranslator);
    ...
    // theLanguageModel->mySetting->setIniFile(theAppName); // File Name without path or extension
    // theLanguageModel->mySetting->setIniFileExtension("ini");
    //
